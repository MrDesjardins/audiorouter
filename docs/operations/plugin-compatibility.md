...
the worker. Environment values were restored and asserted to match their exact
pre-test presence/value state; DLLs were not modified or registered. This
qualifies local fixtures only and grants no redistribution rights.
