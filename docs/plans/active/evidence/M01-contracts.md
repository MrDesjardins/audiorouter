...
- `crates/storage`: SQLite schema migration, transactional session JSON/history writes, validated bounded import/export, online SQLite backups, and idempotent operation journal.
