...
- Completed the event retention bound with monotonic 15-minute expiry in addition to the 10,000-event cap. Replay prunes expired entries before cursor checks, preserving explicit resync for lost cursors; domain/control tests pass (22/27) with strict Clippy.
