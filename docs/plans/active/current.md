...
- Next M06/PLUG-03 task: connect this adapter to the supervised multi-bus worker execution path and add a bounded end-to-end regression for late/missing results, while retaining the current single-stream worker path.
