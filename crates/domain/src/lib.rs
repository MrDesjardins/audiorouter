...
pub const API_METHODS: [ApiMethodSpec; 77] = [
    ApiMethodSpec {
    ...
    ApiMethodSpec {
        name: "nativeEndpoints.prepare",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::ExternalOperation,
    },
    ApiMethodSpec {
        name: "nativeEndpoints.detach",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::ExternalOperation,
    },
    ApiMethodSpec {
        name: "nativeDuplex.detach",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::ExternalOperation,
    },
    ApiMethodSpec {
        name: "nativeApplications.prepare",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::ExternalOperation,
    },
    ApiMethodSpec {
    ...
    ApiMethodSpec {
        name: "virtualDevices.plan",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::PlanOnly,
    },
    ApiMethodSpec {
        name: "virtualDevices.apply",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::Mutating,
    },
    ApiMethodSpec {
        name: "virtualDevices.provision",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::ExternalOperation,
    },
    ApiMethodSpec {
        name: "virtualDevices.remove",
        permission: PermissionScope::DeviceAdministration,
        side_effect: SideEffectClass::ExternalOperation,
    },
    ApiMethodSpec {
    ...
    for (index, node) in session.nodes.iter().enumerate() {
        ...
        for (index, (name, value)) in node.parameters.iter().enumerate() {
            ...
            let valid = match (node.kind, name.as_str()) {
                ...
                (NodeKind::Gate, "thresholdDb") => value.as_f64().is_some_and(|threshold| {
                    threshold.is_finite() && (-80.0..=0.0).contains(&threshold)
                }),
