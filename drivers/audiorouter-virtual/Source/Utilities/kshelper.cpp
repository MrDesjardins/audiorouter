...
#pragma code_seg("PAGE")
NTSTATUS
AudioRouterVirtualPropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a AUDIOROUTERVIRTUAL_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    AUDIOROUTERVIRTUAL_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    AUDIOROUTERVIRTUAL_PROPERTY_ITEM* item = (AUDIOROUTERVIRTUAL_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
