...
Abstract:
    ...
    Declaration of AudioRouter Virtual HW class.
    AudioRouter Virtual HW has an array for storing mixer and volume settings
    for the topology.
--*/

#ifndef _AUDIOROUTERVIRTUAL_HW_H_
#define _AUDIOROUTERVIRTUAL_HW_H_
...
// This class represents virtual AudioRouter Virtual HW. An array representing volume
// registers and mute registers.

class CAudioRouterVirtualHW
{
public:
protected:
...
typedef CAudioRouterVirtualHW    *PCAudioRouterVirtualHW;

#endif  // _AUDIOROUTERVIRTUAL_HW_H_
