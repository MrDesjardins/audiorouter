...
Abstract:
    ...
    Declaration of AudioRouter Virtual sine wave generator.
--*/
#ifndef _AUDIOROUTERVIRTUAL_TONEGENERATOR_H
#define _AUDIOROUTERVIRTUAL_TONEGENERATOR_H
...
#endif // _AUDIOROUTERVIRTUAL_TONEGENERATOR_H
