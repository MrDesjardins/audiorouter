...
Abstract:
    ...
    Declaration of AudioRouter Virtual data saving class. This class supplies services
to save data to disk.

--*/

#ifndef _AUDIOROUTERVIRTUAL_SAVEDATA_H
#define _AUDIOROUTERVIRTUAL_SAVEDATA_H
