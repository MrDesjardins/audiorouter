...
#ifndef _AUDIOROUTERVIRTUAL_COMMON_H_
#define _AUDIOROUTERVIRTUAL_COMMON_H_
...
//
//=============================================================================
typedef struct _AUDIOROUTERVIRTUAL_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} AUDIOROUTERVIRTUAL_DEVPROPERTY, PAUDIOROUTERVIRTUAL_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with AUDIOROUTERVIRTUAL.<TopoName>.szPname in the inf's [Strings] section
    ...
    const AUDIOROUTERVIRTUAL_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with AUDIOROUTERVIRTUAL.<WaveName>.szPname in the inf's [Strings] section
    ...
    const AUDIOROUTERVIRTUAL_DEVPROPERTY*       WaveInterfaceProperties;
...
#endif  //_AUDIOROUTERVIRTUAL_COMMON_H_
