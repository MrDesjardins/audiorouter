...
CMiniportTopologyAudioRouterVirtual::CMiniportTopologyAudioRouterVirtual
(
...
} // CMiniportTopologyAudioRouterVirtual
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyAudioRouterVirtual::DataRangeIntersection
(
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyAudioRouterVirtual::GetDescription
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyAudioRouterVirtual::Init
(
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyAudioRouterVirtual::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyAudioRouterVirtual::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyAudioRouterVirtual::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyAudioRouterVirtual::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyAudioRouterVirtual::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyAudioRouterVirtual::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyAudioRouterVirtual::GenerateEventList]"));
