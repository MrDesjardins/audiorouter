...
--*/
{
    ...
    return CMiniportTopologyAudioRouterVirtual::GetDescription(OutFilterDescriptor);
} // GetDescription
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyAudioRouterVirtual::Init failed, 0x%x", ntStatus)),
        Done);
