...
#ifndef _AUDIOROUTERVIRTUAL_MINWAVERT_H_
#define _AUDIOROUTERVIRTUAL_MINWAVERT_H_
...
#pragma code_seg()
    ...
    friend class        CMiniportTopologyAudioRouterVirtual;
...
#endif // _AUDIOROUTERVIRTUAL_MINWAVERT_H_
