...
#ifndef _AUDIOROUTERVIRTUAL_MICARRAYTOPO_H_
#define _AUDIOROUTERVIRTUAL_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyAudioRouterVirtual,
...
public:
    ...
    (
        ...
        CMiniportTopologyAudioRouterVirtual(FilterDesc, DeviceMaxChannels),
...
#endif // _AUDIOROUTERVIRTUAL_MICARRAYTOPO_H_
