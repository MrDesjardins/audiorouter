...
#ifndef _AUDIOROUTERVIRTUAL_MICARRAYWAVTABLE_H_
#define _AUDIOROUTERVIRTUAL_MICARRAYWAVTABLE_H_
...
static
AUDIOROUTERVIRTUAL_PROPERTY_ITEM PropertiesMicArrayWaveFilter[] =
{
    {
        {
            &KSPROPSETID_General,
...
#endif // _AUDIOROUTERVIRTUAL_MICARRAYWAVTABLE_H_
