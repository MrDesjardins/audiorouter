...
export function App({ backend = defaultBackend }: { backend?: UiBackend } = {}) {
  ...
  useEffect(() => {
    ...
    const onKeyDown = (event: KeyboardEvent) => { if (event.key === "Escape") { event.preventDefault(); closeConnectionDialog(); } };
