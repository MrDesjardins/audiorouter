    ...
    try {
      ...
      if (multiPathRoute) {
        if (!sameSessionDraft(draftRef.current, session)) {
          setActionMessage("No audio started. Save the route, then press Play: a session with several paths plays its saved route.");
          return false;
        }
