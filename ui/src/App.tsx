...
function PluginScanPanel({ backend, onAddPlaceholder: _onAddPlaceholder }: { backend: UiBackend; onAddPlaceholder?: (entry: import("@audiorouter/contracts").PluginScanEntry) => void }) {
