...
export function GraphList({ session, selectedNodeId, onSelect, onRemoveConnection, onToggleConnection, onInsertProcessor, onOpenPluginPicker }: { session: Session; selectedNodeId: string; onSelect: (id: string) => void; onRemoveConnection: (id: string) => void; onToggleConnection: (id: string, enabled: boolean) => void; onInsertProcessor?: (edgeId: string, kind: (typeof PROCESSOR_ACTIONS)[number]["kind"]) => void; onOpenPluginPicker?: (edgeId: string) => void }) {
