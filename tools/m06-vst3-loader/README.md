...
the module. It also processes one bounded offline stereo block and checks that
the output is finite. It does not create an editor, open an audio device, or
