...
Write-Output 'M06 VST2 chunk-state fixture acceptance passed.'
Write-Output 'Scope: repository-owned ignored DLL and disposable worker; no plugin registration or audio configuration changes.'
